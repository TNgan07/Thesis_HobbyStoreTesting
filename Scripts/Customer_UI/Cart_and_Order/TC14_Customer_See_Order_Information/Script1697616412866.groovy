...
WebUI.setText(findTestObject('Page_Hobby_Login/Hobby_Login_inputEmail'), 'demo1@gmail.com')

WebUI.setEncryptedText(findTestObject('Page_Hobby_Login/Hobby_Login_inputPassword'), '4nvbrPglk7k=')
...
WebUI.click(findTestObject('Page_Hobby_E2E_Testing/Hobby_inputPaybyCash'))

WebUI.click(findTestObject('Page_Hobby_E2E_Testing/Hobby_buttonOrder'))

WebUI.click(findTestObject('Page_Hobby_E2E_Testing/Hobby_buttonConfirm'))

WebUI.click(findTestObject('Page_Hobby_E2E_Testing/Hobby_buttonSeeOrder'))

WebUI.click(findTestObject('Page_Hobby_E2E_Testing/Hobby_Logout_imgAccount'))

WebUI.click(findTestObject('Page_Hobby_E2E_Testing/Hobby_Logout_li_Logout'))
